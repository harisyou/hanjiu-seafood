...
import { isValidTaiwanMobile, normalizeTaiwanMobile, taipeiToday, validateTaipeiDateTime } from "@/lib/customer-validation";
...
export default function FishRequestForm() {
  ...
  return <form className="fishRequestForm" onSubmit={submit} noValidate>
    <div className="fishRequestFields">
      ...
      <label>希望收到日期（選填）<input type="date" min={taipeiToday()} value={form.wantedBy} onChange={(event) => setForm({ ...form, wantedBy: event.target.value })} /></label>
