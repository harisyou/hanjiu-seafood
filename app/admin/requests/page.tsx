...
export default function AdminRequestsPage() {
  ...
  const loadRequests = useCallback(async () => {
    const [requestResult, productResult, variantResult] = await Promise.all([
    ...
    if (requestResult.error || productResult.error || variantResult.error) setNotice("需求與到貨資料載入失敗，請確認管理員權限。");
    else {
